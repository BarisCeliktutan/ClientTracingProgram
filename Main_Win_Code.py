...
class MainWindow(QMainWindow):
    ...
    def fetch_processes(self):
        ...
        try:
            if self.main_win.tbwTabs.item(self.main_win.tbwTabs.currentRow(), 1).text() == "TATÝL SATIŢ":
    ...
    def exit(self):
        ...
        if self.lang_flag == 1:
            ...
            msg.setText("Çýkmak istediđinden emin misin?")
    ...
    def tab(self):
        ...
        if tab in "VATANDAŢLIK CITIZENSHIP":
            if self.lang_flag == 0:
                self.main_win.lblProcesses.setText("VATANDAŢLIK ÝŢLEMLERÝ")
            else:
            ...
            if self.lang_flag == 0:
                self.main_win.lblProcesses.setText("VÝZE ÝŢLEMLERÝ")
            else:
                self.main_win.lblProcesses.setText("CITIZENSHIP PROCESSES")
            self.main_win.frmProcesses.show()
        ...
        elif tab in "TATÝL SATIŢ HOLIDAY SELLINGS":
            if self.lang_flag == 0:
                self.main_win.lblProcesses.setText("TATÝL SATIŢ")
            else:
                self.main_win.lblProcesses.setText("CITIZENSHIP PROCESSES")
            self.main_win.frmProcesses.show()
            self.main_win.frmVisa.hide()
